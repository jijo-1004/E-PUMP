...
?>
		...
		<!-- Main -->
			<section id="main">
            	...
            	<tr>
            		...
            		<td>
            			<input type=text name="amt" id="amt" required="required" style="font-size: 15px; color: white" pattern="[0-9]{}" placeholder="Enter the Amount(Maximum 1000rs)">
            		</td>
            	</tr>
            	<tr>
                    <td>
                        <p>Enter Location Latitude :: </p>
                    </td>
                    <td>
                        <input type=text name="long" id="long" required="required" style="font-size: 15px; color: white" placeholder="your present Location Latitude">
                    </td>
                </tr>
				<tr>
                    <td>
                        <p>Enter Location Longitude :: </p>
                    </td>
                    <td>
                        <input type=text name="lat" id="lat" required="required" style="font-size: 15px; color: white" placeholder="your present Location Longitude">
                    </td>
                </tr><!-- <tr>
                    <td>
                        <p>Location :: </p>
                    ...
                    <td>
                        <textarea id=demo name="demo"  style="font-size: 15px; color: white" placeholder="your present Location"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <!-- <input type=text name="req_ltr" id="req_ltr" required="required" style="font-size: 15px; color: white" placeholder="(Calculated Litre)" disabled=disabled> -->
          ...
          <table align="center">
            ...
            <td>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button class="form-control2">
            <a  name="or_cancel" class="form-control2" id="or_cancel" value="Cancel" href="../user_home.php"> Cancel</a>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </button>
            </td>
