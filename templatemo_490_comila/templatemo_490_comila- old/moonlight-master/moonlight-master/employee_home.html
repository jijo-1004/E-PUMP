      ...
      <div class="seq-preloader">
        ...
        <nav>
          ...
          <ul>
            ...
            <li><a href="#2"><i class="fa fa-user"></i> <em>Fuel Orders</em></a></li>
            <li><a href="#3"><i class="fa fa-pencil"></i> <em>Accepting Order</em></a></li>
            <li><a href="#4"><i class="fa fa-envelope"></i> <em>View Payment</em></a></li>
            <li><a href="#5"><i class="fa fa-envelope"></i> <em>Feedback</em></a></li>
          </ul>
        </nav>
          ...
          <div class="slide" id="1">
            <div class="content first-content">
              <div class="container-fluid">
                  <div class="col-md-3">
                      <div class="author-image"><img src="img/Logo_ars.png" alt=""></div>
                  </div>
                  <div class="col-md-9">
                      <h2>Employee</h2>
                      <div>
                  ...
                  <div class="col-md-9">
                      <div class="main-btn">
                        <a href="#2">View Orders</a>
                      </div>
                      <div>
                        <h3>  </h3>
                      </div>                      
                      <div class="main-btn">
                        <a href="#4">View Payment</a>
                      </div>
                      <div>
                        <h3>  </h3>
                      </div>
                      <div class="main-btn">
                        <a href="#5">View Feedback</a>
                      </div>                
                   </div>
                </div>
              </div>
